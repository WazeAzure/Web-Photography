...
const Contact = () => {
    ...
    const handleSave = async (e) => {
        ...
        const docRef = doc(db, "deskripsi-utama", "syqCf0qzVDUIjqTENw0d");
    ...
    useEffect(() => {
        const unsubscribe = onSnapshot(doc(db, "deskripsi-utama", "syqCf0qzVDUIjqTENw0d"), { includeMetadataChanges: true},
        (doc) => {
            const data = doc.data()
    ...
    return (
        <div className="container align-middle" style={{marginTop: "1rem"}}>
            <h1 style={{marginBottom: "2rem"}}><span style={{marginRight: "1rem"}}>Contact</span>
            { isAuthenticated &&
